...
import { GiEclipseFlare, GiFeather } from "react-icons/gi";
    ...
    <div className={`${dancingScript.className} mx-auto w-full max-w-2xl`}>
      <ul className="grid grid-cols-1 gap-2 md:grid-cols-2">
        {names.map((name, index) => (
          ...
          >
            <GiEclipseFlare className="size-6 text-gray-800 dark:text-gray-200" />
            {name}
            <GiEclipseFlare className="size-6 text-gray-200 dark:text-gray-800" />
          </li>
        ))}
      </ul>
    </div>
