    ...
    <main className="relative flex min-h-screen flex-col bg-white px-4 py-24 dark:bg-gray-700">
      <div className="relative mx-auto w-full max-w-[800px]">
        ...
        <div className="absolute inset-0 flex h-full flex-col items-center justify-center gap-20">
          ...
          <div className="cursor-pointer text-center font-semibold uppercase text-gray-800 hover:text-gray-800 dark:text-gray-50 dark:hover:text-gray-400 md:text-lg lg:text-2xl">
            <Link
              ...
              target="_blank"
            >
              <p className="underline">Jhoenie&apos;s Island Resort</p>
